    ...
    <>
      <section className="mt-20 lg:mt-28 z-10 w-full">
        <article className="mt-24 text-white lg:ml-10 text-center lg:text-start">
          ...
          <p className="mt-4 lg:text-3xl text-3xl px-4 lg:px-0">
            I am a <span className="text-blue-600">Software Developer</span>,{" "}
            <br /> and I provide custom web solutions for your services.{" "}
          </p>
        </article>
        <article className="grid lg:w-1/2 grid-rows-2 grid-cols-2 gap-x-4 text-xl lg:text-2xl lg:ml-10 px-10 lg:px-0 mt-8 lg:h-32 h-28">
          ...
          <button className="text-white rounded-md border border-blue-600">
        ...
        <article className="mt-8 text-center  ">
          ...
          <div className="grid grid-flow-col lg:space-x-10 mt-2 justify-center items-center">
        ...
        <article className="text-center mt-10">
          ...
          <article className="w-40 mx-auto">
            <Link to="/projects">
              <div
                onClick={scrollToTop}
                className="text-blue-500 mx-auto cursor-pointer items-center flex flex-row justify-center border-blue-500 border rounded-md h-10 mt-6 lg:mt-10"
              >
        ...
        <article className="text-center mt-16 flex flex-col space-y-5 text-white">
          ...
          <Link to="/contact">
            <button
              onClick={scrollToTop}
              className="bg-green-500 text-xl  h-10 lg:w-1/3 w-3/4 rounded-md text-white"
            >
              Contact me
            </button>
          </Link>
